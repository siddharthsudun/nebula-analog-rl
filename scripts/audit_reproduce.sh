...
$PY -m eqrl.experiments.policy_rollout --model "$M" --specs 32 \
...
$PY -m eqrl.experiments.policy_rollout --model "$M" --specs 32 --boost-tol 1.5 \
...
$PY -m eqrl.experiments.reward_audit --model "$M" --episodes 12 \
