...
from silq.envs.equalizer_env import _margins, compute_reward
from silq.sim.measures import Measures, measure_all
...
class SequentialEqualizerEnv(gym.Env):  # type: ignore[misc]
    ...
    def _measure(self, x: np.ndarray) -> Measures:
        ...
        if self.feasible_decode:
            from silq.circuits.ctle import project_feasible
