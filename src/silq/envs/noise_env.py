...
from silq.snr_spec import SNRRequest, experimental_request
from silq.sim.snr_evaluation import evaluate_snr, signal_calibration
...
class NoiseEqualizerEnv(SequentialEqualizerEnv):
    ...
    def _heartbeat(self, stage):
        if self.heartbeat_path is not None:
            from silq.agents.train_noise_pilot import _write_json
            import os, time
