...
from silq.experiments import g32_repair as _g32
from silq.experiments import hybrid_audit as _h1
...
#
# These were closures inside main() until the public entry point (silq.pipeline) needed
