...
corpus decides only where to look. `silq.surrogate`: "IT IS A RANKER, NEVER A JUDGE."
"""
...
def corpus_areas_mm2(surrogate) -> np.ndarray:
    ...
    from silq.circuits.ctle import (ACTION_SPACE, MIRROR_DENSITY_A_PER_UM, MIRROR_L_UM,
                                    MIRROR_W_MAX_UM, MIRROR_W_MIN_UM, DesignVars)
    from silq.surrogate import KEYS, _HI, _LO, _LOG
