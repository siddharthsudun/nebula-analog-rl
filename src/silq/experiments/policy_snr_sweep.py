...
from silq.circuits.ctle import DesignVars, decode_action  # noqa: E402
from silq.sim.eye import EyeResultV2, compute_eye_v2  # noqa: E402
from silq.specs import DEFAULT_SPEC, hard_pass  # noqa: E402

# `silq.envs` pulls in gymnasium and `silq.sim.server` opens ngspice; both are imported
...
SCHEMA = "silq.policy_snr_sweep.v1"
