...
def main():
    ...
    from silq.agents.train_noise_pilot import _configure_ngspice, _set_single_threaded, _worker_factory, _write_json, _make_callback
    _set_single_threaded()
    _configure_ngspice()
    import numpy as np
    from stable_baselines3.common.vec_env import SubprocVecEnv
    from stable_baselines3 import PPO
    from silq.circuits.ctle import DesignVars, encode_action
    from silq.sim.snr_evaluation import channel_unit_rms
    from silq.experiments.noise_holdout import cases, evaluate_policy
