...
from silq.experiments.g32_regime import probe_start, regime_plane
from silq.experiments.g32_selfcal_bench import GATE_FIELDS, run_arm, validity_gate
...
def main() -> None:
    ...
    from silq.experiments.final_comparison import (PREREG, Evaluation, _check_constants,
                                                   load_policy, stage1_rollout)
    from silq.experiments.g32_peak_report import plane_from_probe
    from silq.experiments.g32_rescue_probe import rescue_order_from_probe
