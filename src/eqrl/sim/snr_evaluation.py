...
from eqrl.sim.eye import compute_eye_v2, _v2_causal_fir, _waveform_rows_v2
...
def evaluate_snr(srv, dv, nominal, spec, request, *, seed=0, eye_bits=512, target_weight=None):
    from eqrl.envs.sequential_env import _shaped
    ...
    coverage = ((.001 <= request.low_vrms <= request.high_vrms <= .05
                ...
                and .5 <= swing <= 1.)
    details = {'schema': 'eqrl.snr.result.v2', 'status': 'measured',
